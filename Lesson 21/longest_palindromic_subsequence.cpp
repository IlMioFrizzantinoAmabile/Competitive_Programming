 ...
 *
 * SOLUTION
 * L'algoritmo utilizza la programmazione dinamica risolvendo i sottoproblemi sulle sottoparole, cioè i caratteri dall'i-esimio al
 * j-esimo per ogni coppia i,j.
