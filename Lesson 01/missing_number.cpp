 ...
 *
 * SOLUTION
 * L'algoritmo scorre l'array e ne calcola la somma degli elementi, usando la nota formula per la somma dei primi n numeri naturali trova
 * il risultato per differenza.
 * COMPLEXITY: O(n)
 */
