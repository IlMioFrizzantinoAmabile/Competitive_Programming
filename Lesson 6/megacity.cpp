 ...
 * Input:
 * The first line of the input contains two integers n and s (1 ≤ n ≤ 103; 1 ≤ s < 106) — the number of locatons around Tomsk city
 * and the population of the city. Then n lines follow. The i-th line contains three integers — the xi and yi coordinate values of
 * the i-th location and the number ki of people in it (1 ≤ ki < 106). Each coordinate is an integer and doesn't exceed 104 in its
 * absolute value. It is guaranteed that no two locations are at the same point and no location is at point (0; 0).
 * Output:
